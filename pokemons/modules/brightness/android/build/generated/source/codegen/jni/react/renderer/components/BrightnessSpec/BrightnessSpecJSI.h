...
namespace facebook::react {
  ...
  class JSI_EXPORT NativeBrightnessCxxSpecJSI : public TurboModule {
protected:
...
template <typename T>
class JSI_EXPORT NativeBrightnessCxxSpec : public TurboModule {
public:
...
protected:
  NativeBrightnessCxxSpec(std::shared_ptr<CallInvoker> jsInvoker)
    : TurboModule(std::string{NativeBrightnessCxxSpec::kModuleName}, jsInvoker),
      delegate_(reinterpret_cast<T*>(this), jsInvoker) {}


private:
  class Delegate : public NativeBrightnessCxxSpecJSI {
  public:
    Delegate(T *instance, std::shared_ptr<CallInvoker> jsInvoker) :
      NativeBrightnessCxxSpecJSI(std::move(jsInvoker)), instance_(instance) {
  ...
  private:
    friend class NativeBrightnessCxxSpec;
    T *instance_;
  };
